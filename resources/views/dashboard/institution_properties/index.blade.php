...
@section('content')
    <div class="recent-orders" style="text-align: center">
        ...
        <!-- زر إضافة عقار جديد -->
        <div class="mb-3">
            <a href="{{ route('dashboard.institution_properties.create') }}" class="btn btn-primary">إضافة عقار جديد</a>
        </div>
            ...
            <tbody>
                @forelse($institutionProperties as $property)
                    <tr>
                        ...
                        <td>
                            <!-- عرض -->
                            <a id="btnb" href="{{ route('dashboard.institution_properties.show', $property->id) }}"
                                class="btn btn-info btn-sm">عرض</a>

                            <!-- تعديل -->
                            <a id="btnb" href="{{ route('dashboard.institution_properties.edit', $property->id) }}"
                                class="btn btn-warning btn-sm">تعديل</a>
                           
                                <!-- حذف -->
                                <form action="{{ route('dashboard.institution_properties.destroy', $property->id) }}"
