...
@section('title', 'إضافة قطاع ضخ جديد')
...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">إضافة قطاع ضخ جديد</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">الرئيسية</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('pumping-sectors.index') }}">قطاعات الضخ</a></li>
            ...
            <div class="col-lg-10 col-xl-8">
                ...
                @if (auth()->check() && auth()->user()->role_id == 'admin')
                    <div class="card card-success collapsed-card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pumping_sectors.import') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <p class="text-muted">يمكنك استيراد قائمة بقطاعات الضخ دفعة واحدة.</p>
                ...
                <div class="card card-primary">
                    ...
                    <!-- بدء الفورم -->
                    <form action="{{ route('pumping-sectors.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="town_id">البلدة التابع لها<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="sector_name">اسم القطاع<span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-tag"></i></span></div>
                                            <input type="text" name="sector_name" id="sector_name" class="form-control"
                                                value="{{ old('sector_name') }}" placeholder="أدخل اسماً تعريفياً للقطاع"
                                                required>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer text-right">
                            ...
                            <a href="{{ route('pumping-sectors.index') }}" class="btn btn-secondary btn-lg">
