...
@section('content')
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        <h1>@yield('title')</h1>
        <div>
            <a href="{{ route('dashboard.daily-station-reports.edit', $dailyStationReport) }}" class="btn btn-edit">
                <span class="material-icons-sharp">edit</span> تعديل
            </a>
            <a href="{{ route('dashboard.daily-station-reports.index') }}" class="btn btn-back">
