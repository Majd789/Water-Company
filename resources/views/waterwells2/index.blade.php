                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('waterwells2.aggregated') }}" class="btn btn-info">
                                        <i class="fas fa-check-double"></i> تدقيق التقرير الإجمالي
                                    </a>
                                </div>
                                <form action="{{ route('waterwells2.destroy') }}" method="POST" class="delete-form">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <form method="GET" action="{{ route('waterwells2.index') }}">
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        @forelse ($filteredWells as $well)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('waterwells2.show', $well->id) }}"
                                                            class="btn btn-sm btn-outline-info" title="عرض">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('waterwells2.edit', $well->id) }}"
                                                            class="btn btn-sm btn-outline-warning" title="تعديل">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('waterwells2.destroy', $well->id) }}"
