        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.electricity-hours.index') }}">عدادات
                            الكهرباء</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3 mb-4">
            <div class="col-12 text-center">
                ...
                <a href="{{ route('dashboard.electricity-hours.index') }}" class="btn btn-lg btn-secondary"><i
