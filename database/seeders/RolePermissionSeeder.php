...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $models = [
            ...
            'project_general_statuses' => 'الحالات العامة للمشاريع',
            'project_specific_statuses' => 'الحالات الخاصة للمشاريع',
            'project_main_statuses' => 'الحالات الرئيسية للمشاريع',
            'project_types' => 'أنواع المشاريع',
            'master_activities' => 'الأنشطة الرئيسية',
            'months' => 'الأشهر',
            'contractor_statuses' => 'حالات المقاولين',
            'handover_statuses' => 'حالات التسليم',
            'contractor_tasks' => 'مهام المقاولين',
