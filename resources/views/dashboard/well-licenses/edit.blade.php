...
@section('title', 'تعديل بيانات ترخيص بئر')
...
@push('styles')
    ...
    <style>
        ...
        .form-control:invalid { border-color: #dc3545 !important; }
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>تعديل ترخيص: <span class="text-primary">{{ $wellLicense->archive_code }}</span></h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title mb-0">
                                ...
                                تعديل بيانات ترخيص البئر
                            </h3>
                        </div>

                        <form action="{{ route('dashboard.well-licenses.update', $wellLicense->id) }}" method="POST" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="applicant_name" class="form-control" value="{{ old('applicant_name', $wellLicense->applicant_name) }}" placeholder="أدخل اسم مقدم الطلب" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="request_type" class="form-control select2" required>
                                                ...
                                                @foreach ($requestTypes as $type)
                                                    <option value="{{ $type }}" {{ old('request_type', $wellLicense->request_type) == $type ? 'selected' : '' }}>
                                                        {{ $type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="property_number" class="form-control" value="{{ old('property_number', $wellLicense->property_number) }}" placeholder="أدخل رقم العقار" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="property_zone">المنطقة العقارية<span class="text-danger">*</span></label>
                                            <input type="text" name="property_zone" class="form-control" value="{{ old('property_zone', $wellLicense->property_zone) }}" placeholder="أدخل المنطقة العقارية" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="latitude">خط العرض (Latitude)</label>
                                            <input type="number" step="any" name="latitude" class="form-control" value="{{ old('latitude', $wellLicense->latitude) }}" placeholder="مثال: 35.9285">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="longitude">خط الطول (Longitude)</label>
                                            <input type="number" step="any" name="longitude" class="form-control" value="{{ old('longitude', $wellLicense->longitude) }}" placeholder="مثال: 36.7215">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="institution_letter_date" class="form-control" value="{{ old('institution_letter_date', $wellLicense->institution_letter_date?->format('Y-m-d')) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="directorate_letter_date">تاريخ كتاب مديرية الموارد</label>
                                            <input type="date" name="directorate_letter_date" class="form-control" value="{{ old('directorate_letter_date', $wellLicense->directorate_letter_date?->format('Y-m-d')) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="directorate_letter_number">رقم كتاب مديرية الموارد</label>
                                            <input type="text" name="directorate_letter_number" class="form-control" value="{{ old('directorate_letter_number', $wellLicense->directorate_letter_number) }}" placeholder="أدخل رقم الكتاب">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="declared_distance_meters">المسافة المصرح بها (متر)</label>
                                            <input type="number" name="declared_distance_meters" class="form-control" value="{{ old('declared_distance_meters', $wellLicense->declared_distance_meters) }}" placeholder="أدخل المسافة بالأمتار">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="station_id" class="form-control select2">
                                                <option value="">-- اختر المحطة الأقرب (اختياري) --</option>
                                                @foreach ($stations as $station)
                                                    <option value="{{ $station->id }}" {{ old('station_id', $wellLicense->station_id) == $station->id ? 'selected' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="physical_cabinet" class="form-control" value="{{ old('physical_cabinet', $wellLicense->physical_cabinet) }}" placeholder="رقم أو اسم الخزانة">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="physical_shelf">الرف</label>
                                            <input type="text" name="physical_shelf" class="form-control" value="{{ old('physical_shelf', $wellLicense->physical_shelf) }}" placeholder="رقم أو اسم الرف">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="physical_file_id">رقم الملف</label>
                                            <input type="text" name="physical_file_id" class="form-control" value="{{ old('physical_file_id', $wellLicense->physical_file_id) }}" placeholder="رقم الملف على الرف">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="file_url" class="form-control" value="{{ old('file_url', $wellLicense->file_url) }}" placeholder="الصق رابط الملف هنا">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="notes">ملاحظات عامة</label>
                                            <textarea name="notes" class="form-control" rows="3" placeholder="أدخل أي ملاحظات إضافية">{{ old('notes', $wellLicense->notes) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer text-left">
                                <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-save mr-1"></i> حفظ التعديلات</button>
