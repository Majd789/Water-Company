        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.towns.index') }}">البلدات</a></li>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="card card-primary shadow-sm">
                    ...
                    <!-- /.card-header -->
                    <form action="{{ route('dashboard.towns.update', $town->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('dashboard.towns.index') }}" class="btn btn-secondary">إلغاء</a>
                        </div>
                        <!-- /.card-footer -->
                    </form>
                </div>
