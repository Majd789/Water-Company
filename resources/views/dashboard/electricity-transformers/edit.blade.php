        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="card card-primary">
                    ...
                    <form action="{{ route('dashboard.electricity-transformers.update', $electricityTransformer->id) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" name="distance_from_station"
                                                class="form-control"
                                                value="{{ old('dashboard.distance_from_station', $electricityTransformer->distance_from_station) }}"
