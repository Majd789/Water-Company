...
@section('content')
    ...
    <div class="recent-orders" style="text-align: center">
        <div class="login-card">
            <h2>إضافة خزان مرتفع جديد</h2>
            @if (auth()->check() && auth()->user()->role_id == 'admin')
                <form action="{{ route('elevated_tanks.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label for="file">اختر ملف الخزانات المرتفعة (Excel أو CSV)</label>
            ...
            <!-- نموذج إضافة خزان مرتفع -->
            <form action="{{ route('elevated-tanks.store') }}" method="POST" class="login-form">
                @csrf
                <!-- حاوية الكروت -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" name="tank_name" id="tank_name"
                                    ...
                                    value="{{ old('tank_name') }}" placeholder="اسم الخزان" required>
                                @error('tank_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <input type="text" name="building_entity" id="building_entity"
                                    ...
                                    value="{{ old('building_entity') }}" placeholder="الجهة المنشئة" required>
                                ...
                                <select name="construction_date" id="construction_date"
                                    ...
                                    <option value="جديد" {{ old('construction_date') == 'جديد' ? 'selected' : '' }}>جديد
                                    </option>
                                    <option value="قديم" {{ old('construction_date') == 'قديم' ? 'selected' : '' }}>قديم
                                    </option>
                                </select>
                                ...
                                <input type="number" name="capacity" id="capacity"
                                    ...
                                    value="{{ old('capacity') }}" placeholder="سعة الخزان" required min="0">
                                @error('capacity')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <input type="number" name="readiness_percentage" id="readiness_percentage"
                                    ...
                                    value="{{ old('readiness_percentage') }}" placeholder="نسبة الجاهزية" required
                                    min="0" max="100">
                                ...
                                <input type="number" name="height" id="height"
                                    class="form-control @error('height') is-invalid @enderror" value="{{ old('height') }}"
                                    placeholder="ارتفاع الخزان" required min="0">
                                @error('height')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" name="feeding_station" id="feeding_station"
                                    ...
                                    value="{{ old('feeding_station') }}" placeholder="المحطة التي تعبئه" required>
                                ...
                                <input type="text" name="town_supply" id="town_supply"
                                    ...
                                    value="{{ old('town_supply') }}" placeholder="البلدة التي تشرب منه" required>
                                @error('town_supply')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <input type="number" name="in_pipe_diameter" id="in_pipe_diameter"
                                    ...
                                    value="{{ old('in_pipe_diameter') }}" placeholder=" قطر البوري الداخل" required
                                    min="0">
                                ...
                                <input type="number" name="out_pipe_diameter" id="out_pipe_diameter"
                                    ...
                                    value="{{ old('out_pipe_diameter') }}" placeholder="قطر البوري الخارج" required
                                    min="0">
                                ...
                                <input type="number" step="any" name="latitude" id="latitude"
                                    ...
                                    value="{{ old('latitude') }}" placeholder="خط العرض">
                                @error('latitude')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <input type="number" step="any" name="longitude" id="longitude"
                                    ...
                                    value="{{ old('longitude') }}" placeholder="خط الطول">
                                @error('longitude')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <input type="number" step="any" name="altitude" id="altitude"
                                    ...
                                    value="{{ old('altitude') }}" placeholder="الارتفاع">
                                @error('altitude')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <input type="number" step="any" name="precision" id="precision"
                                    ...
                                    value="{{ old('precision') }}" placeholder="دقة الموقع">
                                @error('precision')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
