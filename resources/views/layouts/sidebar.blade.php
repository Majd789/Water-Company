                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @php
                        $projectManagementPermissions = [
                            'projects.view', 'project_activities.view', 'organizations.view', // المجموعة الأولى
                            'project_contractors.view', 'contractor_tasks.view', 'contractors.view', // المجموعة الثانية
                            'master_activities.view', 'project_types.view', 'project_main_statuses.view', // الإعدادات
                            'project_general_statuses.view', 'contractor_statuses.view', 'handover_statuses.view',
                        ];
                        $projectManagementRoutes = [
                            'dashboard.projects.*', 'dashboard.project-activities.*', 'dashboard.organizations.*',
                            'dashboard.project-contractors.*', 'dashboard.contractor-tasks.*', 'dashboard.contractors.*',
                  ...
                  <x-sidebar-menu-section title="إدارة المشاريع" icon="fas fa-project-diagram" :permissions="$projectManagementPermissions" :routes="$projectManagementRoutes">
                    ...
                    {{-- المجموعة الأولى: المشاريع والمنظمات --}}
                    <li class="nav-header">المشاريع والمنظمات</li>
                    ...
                    {{-- قسم التقارير (جديد) --}}
                    {{-- ================================================= --}}
                    <li class="nav-header">التقارير والتحليل</li>

                    {{-- ملاحظة: تأكد من إضافة صلاحية reports.view في النظام أو إزالة @can مؤقتاً --}}
                    @can('reports.view')
                    <li class="nav-item">
                    ...
                    {{-- المجموعة الثانية: المقاولين --}}
                    <li class="nav-header">إدارة المقاولين</li>
                    ...
                    {{-- المجموعة الثالثة: إعدادات المشاريع --}}
