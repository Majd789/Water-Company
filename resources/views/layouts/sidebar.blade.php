        ...
        @auth
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    {{-- 3. القسم التقني --}}
                    @canany(['station_reports.view', 'units.view', 'towns.view', 'stations.view', 'wells.view',
                        'generation_groups.view', 'solar_energies.view', 'horizontal_pumps.view', 'ground_tanks.view',
                        'elevated_tanks.view', 'pumping_sectors.view', 'electricity_hours.view',
                        'electricity_transformers.view', 'privet_wells.view', 'infiltrators.view', 'filters.view',
                        'manholes.view', 'diesel_tanks.view'])
                        @php
                            $technicalRoutes = [
                        ...
                        @endphp
                        <li class="nav-item has-treeview {{ Request::routeIs($technicalRoutes) ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ Request::routeIs($technicalRoutes) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-desktop"></i>
                                <p>القسم التقني <i class="right fas fa-angle-left"></i></p>
                            </a>
                    ...
                    @canany(['users.view', 'roles.view'])
                        ...
                        @endphp
                        <li class="nav-item has-treeview {{ Request::routeIs($settingsRoutes) ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ Request::routeIs($settingsRoutes) ? 'active' : '' }}">
