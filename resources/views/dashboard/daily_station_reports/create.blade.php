...
@section('content')
    <div class="form-page-container"> {{-- حاوية خارجية جديدة للصفحة --}}
        <div class="form-card-container kobo-style-card"> {{-- كلاس جديد للبطاقة الرئيسية --}}
            ...
            <form action="{{ route('dashboard.daily-station-reports.store') }}" method="POST" class="main-form" novalidate>
                @include('dashboard.daily_station_reports._form', [
                ...
                <div class="form-actions-footer mt-4 pt-3">
                    ...
                    <a href="{{ route('dashboard.daily-station-reports.index') }}"
