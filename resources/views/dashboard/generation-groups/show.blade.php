        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.generation-groups.index') }}">مجموعات
                            التوليد</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3 mb-4">
            <div class="col-12 text-center">
                <a href="{{ route('dashboard.generation-groups.edit', $generationGroup->id) }}"
                    class="btn btn-lg btn-warning"><i class="fas fa-edit ml-1"></i> تعديل</a>
                <a href="{{ route('dashboard.generation-groups.index') }}" class="btn btn-lg btn-secondary"><i
