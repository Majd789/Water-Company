                ...
                <div class="col-12">
                    {{-- قسم الفلترة للأدمن --}}
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('dashboard.solar_energy.index') }}"
                                    id="unitFilterForm">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-0">
                                                <a href="{{ route('dashboard.solar_energy.index') }}"
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools d-flex align-items-center">
                                ...
                                <a href="{{ route('dashboard.solar-energies.export', request()->query()) }}"
                                        ...
                                        @forelse ($solarEnergies as $solarEnergy)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('dashboard.solar_energy.show', $solarEnergy->id) }}"
