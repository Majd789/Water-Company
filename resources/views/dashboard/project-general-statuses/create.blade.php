@extends('layouts.app')
@section('title', 'إضافة حالة مشروع عامة جديدة')
...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">إضافة حالة مشروع عامة جديدة</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                ...
                <div class="card card-primary">
                    ...
                    <form action="{{ route('dashboard.project-general-statuses.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
