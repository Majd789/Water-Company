                ...
                <div class="col-12">
                    ...
                    @if (auth()->check() && (auth()->user()->role_id == 'admin' || auth()->user()->unit_id == null))
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('diesel_tanks.index') }}" id="unitFilterForm">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools d-flex align-items-center">
                                <a href="{{ route('diesel-tanks.export', request()->query()) }}"
                                    class="btn btn-success ml-2">
                                    <i class="fas fa-file-excel"></i> تصدير Excel
                                </a>
                                @if (auth()->check() && in_array(auth()->user()->role_id, ['admin', 'super']))
                                    <a href="{{ route('diesel_tanks.create') }}" class="btn btn-primary">
                                        ...
                                        @forelse($dieselTanks as $dieselTank)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('diesel_tanks.show', $dieselTank->id) }}"
                                                            class="btn btn-sm btn-outline-info" title="عرض">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        @if (auth()->check() && in_array(auth()->user()->role_id, ['admin', 'super']))
                                                            <a href="{{ route('diesel_tanks.edit', $dieselTank->id) }}"
                                                        ...
                                                        @if (auth()->check() && auth()->user()->role_id == 'admin')
                                                            <form
                                                                action="{{ route('diesel_tanks.destroy', $dieselTank->id) }}"
