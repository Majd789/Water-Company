...
class StationStatsSheetExport implements FromQuery, WithHeadings, WithTitle
{
    /**
    ...
    */
    public function query()
    {
        ...
        )->groupBy('station_reports.وحدة المياه', 'station_reports.المحطات');
    ...
    {
        // أسماء الأعمدة في ملف Excel (يجب أن تتطابق مع ترتيب الاستعلام)
        return [
            'وحدة المياه',
            'المحطة',
