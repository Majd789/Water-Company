{{-- resources/views/dashboard/water_quality_tests/edit.blade.php --}}
@extends('layouts.app')
@section('title', 'تعديل فحص جودة مياه')

@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">تعديل فحص جودة مياه</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row justify-content-center">
            ...
            @include('dashboard.partials.alerts')
                ...
                <div class="card card-primary">
                    ...
                    <form action="{{ route('dashboard.water-quality-tests.update', $waterQualityTest->id) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
