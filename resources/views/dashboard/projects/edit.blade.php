                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                               placeholder="أدخل اسم المشروع" value="{{ old('name', $project->name) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="project_code">كود المشروع<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="project_code" name="project_code"
                                               placeholder="مثال: GOL-25-JAN-001" value="{{ old('project_code', $project->project_code) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="organization_id" class="form-control select2" id="organization_id" required>
                                            <option value="" disabled>-- اختر المنظمة --</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="donor_name" name="donor_name"
                                               placeholder="أدخل اسم الجهة المانحة" value="{{ old('donor_name', $project->donor_name) }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="supervisor_name" name="supervisor_name"
                                               placeholder="أدخل اسم المشرف" value="{{ old('supervisor_name', $project->supervisor_name) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="supervisor_phone" name="supervisor_phone"
                                               placeholder="أدخل رقم التواصل" value="{{ old('supervisor_phone', $project->supervisor_phone) }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="main_status_id" class="form-control select2" id="main_status_id" required>
                                            @foreach ($mainStatuses as $status)
                                                <option value="{{ $status->id }}" {{ old('main_status_id', $project->main_status_id) == $status->id ? 'selected' : '' }}>
                                                    {{ $status->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="general_status_id" class="form-control select2" id="general_status_id" required>
                                            @foreach ($generalStatuses as $status)
                                                <option value="{{ $status->id }}" {{ old('general_status_id', $project->general_status_id) == $status->id ? 'selected' : '' }}>
                                                    {{ $status->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="total_value" name="total_value"
                                               placeholder="أدخل القيمة الإجمالية" value="{{ old('total_value', $project->total_value) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="handover_status_id" class="form-control select2" id="handover_status_id" required>
                                            @foreach ($handoverStatuses as $status)
                                                <option value="{{ $status->id }}" {{ old('handover_status_id', $project->handover_status_id) == $status->id ? 'selected' : '' }}>
                                                    {{ $status->name }}
                                                </option>
                                            @endforeach
                                        </select>
