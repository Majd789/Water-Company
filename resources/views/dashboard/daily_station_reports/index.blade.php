...
@section('content')
    ...
    <div class="page-header"> {{-- افترض وجود تنسيق .page-header --}}
        <h1>@yield('title')</h1>
        <a href="{{ route('dashboard.daily-station-reports.create') }}" class="btn btn-primary"> {{-- افترض وجود تنسيق .btn .btn-primary --}}
                    ...
                    <tbody>
                        @foreach ($reports as $report)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('dashboard.daily-station-reports.show', $report) }}"
                                        class="btn-action btn-info" title="عرض">
                                        <span class="material-icons-sharp">visibility</span>
                                    </a>
                                    <a href="{{ route('dashboard.daily-station-reports.edit', $report) }}"
                                        class="btn-action btn-warning" title="تعديل">
                                        <span class="material-icons-sharp">edit</span>
                                    </a>
                                    <form action="{{ route('dashboard.daily-station-reports.destroy', $report) }}"
