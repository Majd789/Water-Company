                ...
                <div class="col-12">
                    ...
                    @if (auth()->check() && (auth()->user()->role_id == 'admin' || auth()->user()->unit_id == null))
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('electricity-hours.index') }}" id="unitFilterForm">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools d-flex align-items-center">
                                <a href="{{ route('electricity-hours.export', request()->query()) }}"
                                    class="btn btn-success ml-2">
                                    <i class="fas fa-file-excel"></i> تصدير Excel
                                </a>
                                @if (auth()->check() && in_array(auth()->user()->role_id, ['admin', 'super']))
                                    <a href="{{ route('electricity-hours.create') }}" class="btn btn-primary">
                                        ...
                                        @forelse ($electricityHours as $electricityHour)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('electricity-hours.show', $electricityHour->id) }}"
                                                            class="btn btn-sm btn-outline-info" title="عرض">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        @if (auth()->check() && in_array(auth()->user()->role_id, ['admin', 'super']))
                                                            <a href="{{ route('electricity-hours.edit', $electricityHour->id) }}"
                                                        ...
                                                        @if (auth()->check() && auth()->user()->role_id == 'admin')
                                                            <form
                                                                action="{{ route('electricity-hours.destroy', $electricityHour->id) }}"
