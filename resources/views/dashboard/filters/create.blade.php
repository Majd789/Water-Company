            ...
            <div class="col-lg-11 col-xl-10">
                ...
                @endif
                    ...
                    <div class="card card-success collapsed-card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('dashboard.filters.import') }}" method="POST"
                ...
                <div class="card card-primary">
                    ...
                    <!-- بدء الفورم -->
                    <form action="{{ route('dashboard.filters.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="card-footer text-left">
                            ...
                            <a href="{{ route('dashboard.filters.index') }}" class="btn btn-secondary btn-lg">
