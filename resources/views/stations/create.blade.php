...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">إضافة محطة جديدة</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">الرئيسية</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('stations.index') }}">المحطات</a></li>
    ...
    <div class="container-fluid pt-3">
        <div class="row justify-content-center">
            <div class="col-lg-11 col-xl-10"> {{-- تم تكبير العرض قليلاً ليناسب الحقول الكثيرة --}}
                ...
                <!-- قسم استيراد المحطات (باللون الأخضر حسب الطلب) -->
                    ...
                    <div class="card card-success collapsed-card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('stations.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <p class="text-muted">يمكنك استيراد قائمة بالمحطات دفعة واحدة من ملف إكسل.</p>
                ...
                <!-- الفورم الرئيسي لإضافة محطة جديدة -->
                <div class="card card-primary">
                    ...
                    <!-- بدء الفورم -->
                    <form action="{{ route('stations.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="station_code" name="station_code"
                                                placeholder="أدخل كود المحطة" value="{{ old('station_code') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="station_name" name="station_name"
                                                placeholder="أدخل اسم المحطة" value="{{ old('station_name') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="operational_status" class="form-control" required>
                                                ...
                                                <option value="خارج الخدمة"
                                                    {{ old('operational_status') == 'خارج الخدمة' ? 'selected' : '' }}>خارج
                                                    الخدمة</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="stop_reason"
                                                placeholder="أدخل سبب التوقف" value="{{ old('stop_reason') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="station_type" class="form-control">
                                                <option value="محطة ابار ارتوازيه"
                                                    {{ old('station_type') == 'محطة ابار ارتوازيه' ? 'selected' : '' }}>
                                                    محطة آبار ارتوازية</option>
                                                <option value="محطة رفع"
                                                    {{ old('station_type') == 'محطة رفع' ? 'selected' : '' }}>محطة رفع
                                                </option>
                                                <option value="محطة آبار سطحية"
                                                    {{ old('station_type') == 'محطة آبار سطحية' ? 'selected' : '' }}>محطة
                                                    آبار سطحية</option>
                                                <option value="محطة ضخ"
                                                    {{ old('station_type') == 'محطة ضخ' ? 'selected' : '' }}>محطة ضخ
                                                </option>
                                                <option value="محطة ابار ارتوازيه ورفع"
                                                    {{ old('station_type') == 'محطة ابار ارتوازيه ورفع' ? 'selected' : '' }}>
                                                    محطة آبار ارتوازية ورفع</option>
                                                <option value="محطة نبع"
                                                    {{ old('station_type') == 'محطة نبع' ? 'selected' : '' }}>محطة نبع
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="operator_entity" class="form-control" id="operator_entity">
                                                <option value="تشغيل تشاركي"
                                                    {{ old('operator_entity') == 'تشغيل تشاركي' ? 'selected' : '' }}>تشغيل
                                                    تشاركي</option>
                                                <option value="المؤسسة العامة لمياه الشرب"
                                                    {{ old('operator_entity') == 'المؤسسة العامة لمياه الشرب' ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="water_delivery_method" class="form-control">
                                                ...
                                                <option value="شبكة"
                                                    {{ old('water_delivery_method') == 'شبكة' ? 'selected' : '' }}>شبكة
                                                </option>
                                                <option value="منهل"
                                                    {{ old('water_delivery_method') == 'منهل' ? 'selected' : '' }}>منهل
                                                </option>
                                                <option value="شبكة و منهل"
                                                    {{ old('water_delivery_method') == 'شبكة و منهل' ? 'selected' : '' }}>
                                                    شبكة و منهل</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" name="network_readiness_percentage"
                                                ...
                                                value="{{ old('network_readiness_percentage') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                        ...
                                        <select name="network_type" id="network_type" class="form-control select2">
                                            ...
                                            <optgroup label="المواد الأساسية">
                                                <option value="بولي إيثيلين"
                                                    {{ old('network_type') == 'بولي إيثيلين' ? 'selected' : '' }}>بولي
                                                    إيثيلين</option>
                                                <option value="حديد"
                                                    {{ old('network_type') == 'حديد' ? 'selected' : '' }}>حديد</option>
                                                <option value="فونط (حديد صب)"
                                                    {{ old('network_type') == 'فونط (حديد صب)' ? 'selected' : '' }}>فونط
                                                    (حديد صب)</option>
                                                <option value="أترنيت"
                                                    {{ old('network_type') == 'أترنيت' ? 'selected' : '' }}>أترنيت</option>
                                                <option value="PVC"
                                                    {{ old('network_type') == 'PVC' ? 'selected' : '' }}>PVC</option>
                                            </optgroup>
                                            <optgroup label="التوليفات الشائعة">
                                                <option value="بولي إيثيلين و حديد"
                                                    {{ old('network_type') == 'بولي إيثيلين و حديد' ? 'selected' : '' }}>
                                                    بولي إيثيلين و حديد</option>
                                                <option value="بولي إيثيلين و فونط"
                                                    {{ old('network_type') == 'بولي إيثيلين و فونط' ? 'selected' : '' }}>
                                                    بولي إيثيلين و فونط</option>
                                                <option value="بولي إيثيلين و أترنيت"
                                                    {{ old('network_type') == 'بولي إيثيلين و أترنيت' ? 'selected' : '' }}>
                                                    بولي إيثيلين و أترنيت</option>
                                                <option value="حديد و أترنيت"
                                                    {{ old('network_type') == 'حديد و أترنيت' ? 'selected' : '' }}>حديد و
                                                    أترنيت</option>
                                                <option value="PVC و أترنيت"
                                                    {{ old('network_type') == 'PVC و أترنيت' ? 'selected' : '' }}>PVC و
                                                    أترنيت</option>
                                            ...
                                            <optgroup label="أنواع أخرى">
                                                <option value="خط ضخ"
                                                    {{ old('network_type') == 'خط ضخ' ? 'selected' : '' }}>خط ضخ</option>
                                                <option value="غير محدد / أخرى"
                                                    {{ old('network_type') == 'غير محدد / أخرى' ? 'selected' : '' }}>غير
                                                    محدد / أخرى</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="beneficiary_families_count" class="form-control"
                                                ...
                                                value="{{ old('beneficiary_families_count') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="has_disinfection" class="form-control">
                                                <option value="1"
                                                    {{ old('has_disinfection', '1') == '1' ? 'selected' : '' }}>نعم
                                                </option>
                                                <option value="0"
                                                    {{ old('has_disinfection') == '0' ? 'selected' : '' }}>لا</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="disinfection_reason" class="form-control"
                                                placeholder="أدخل السبب" value="{{ old('disinfection_reason') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="any" name="latitude" class="form-control"
                                                placeholder="مثال: 34.7335" value="{{ old('latitude') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="any" name="longitude" class="form-control"
                                                placeholder="مثال: 36.7135" value="{{ old('longitude') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" name="land_area" class="form-control"
                                                placeholder="أدخل مساحة الأرض" value="{{ old('land_area') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="soil_type" id="soil_type" class="form-control">
                                                ...
                                                <option value="أرض زراعية"
                                                    {{ old('soil_type') == 'أرض زراعية' ? 'selected' : '' }}>أرض زراعية
                                                </option>
                                                <option value="أرض صخرية"
                                                    {{ old('soil_type') == 'أرض صخرية' ? 'selected' : '' }}>أرض صخرية
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="detailed_address" class="form-control" rows="2" placeholder="أدخل العنوان التفصيلي للمحطة">{{ old('detailed_address') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="served_locations">المواقع المخدومة</label>
                                        <textarea name="served_locations" class="form-control" rows="2" placeholder="أدخل المواقع التي تخدمها المحطة">{{ old('served_locations') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="building_notes">ملاحظات حول المبنى</label>
                                        <textarea name="building_notes" class="form-control" rows="2" placeholder="أدخل ملاحظات حول حالة المبنى">{{ old('building_notes') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="is_verified" class="form-control">
                                                <option value="1" {{ old('is_verified') == '1' ? 'selected' : '' }}>
                                                    نعم</option>
                                                <option value="0"
                                                    {{ old('is_verified', '0') == '0' ? 'selected' : '' }}>لا</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer text-left"> {{-- تم تغيير المحاذاة لليمين حسب الطلب --}}
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-save ml-1"></i>
                                حفظ المحطة
                            </button>
                            <a href="{{ route('stations.index') }}" class="btn btn-secondary btn-lg">
        ...
        $(function() {
            ...
            function updateOperatorName() {
                ...
                if (operatorEntitySelect.value === 'المؤسسة العامة لمياه الشرب') {
                    ...
                    operatorNameInput.value = '{{ old('operator_name', '') }}';
            ...
            if (operatorEntitySelect) {
                ...
                updateOperatorName(); // تشغيل عند تحميل الصفحة
            }
        });
    </script>
@endpush
