                ...
                <div class="col-12">
                    {{-- قسم الفلترة للأدمن --}}
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('dashboard.pumping-sectors.index') }}"
                                    id="unitFilterForm">
                                    <div class="row align-items-end">
                                        <div class="col-md-9">
                                            <div class="form-group mb-0">
                                                <label>اختر وحدة لعرض أقسامها:</label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-0">
                                                <a href="{{ route('dashboard.pumping-sectors.index') }}"
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                عرض الأقسام <span class="badge badge-primary ml-2">{{ $PumpingSectors->count() }}</span>
                            </h3>
                            <div class="card-tools d-flex align-items-center">
                                {{-- تمرير الفلاتر الحالية لزر التصدير --}}
                                <a href="{{ route('dashboard.pumping-sectors.export', request()->query()) }}"
                                    class="btn btn-success ml-2">
                                    <i class="fas fa-file-excel"></i> تصدير Excel
                                </a>
                              
                                    <a href="{{ route('dashboard.pumping-sectors.create') }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="sectorsTable" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>الاسم</th>
                                    ...
                                    <tbody>
                                        @forelse ($PumpingSectors as $sector)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $sector->sector_name }}</td>
                                                <td>{{ $sector->station->station_name ?? 'N/A' }}</td>
                                                <td>{{ $sector->town->town_name ?? 'N/A' }}</td>
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('dashboard.pumping-sectors.show', $sector->id) }}"
                                                            class="btn btn-sm btn-outline-info" title="عرض">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                       
                                                            <a href="{{ route('dashboard.pumping-sectors.edit', $sector->id) }}"
                                                            ...
                                                            <form
                                                                action="{{ route('dashboard.pumping-sectors.destroy', $sector->id) }}"
...
@push('scripts')
    ...
    <script>
        $(function() {
            ...
            table.buttons().container().appendTo('#sectorsTable_wrapper .col-md-6:eq(0)');
