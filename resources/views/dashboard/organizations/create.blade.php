@extends('layouts.app')
@section('title', 'إضافة منظمة جديدة')
...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">إضافة منظمة جديدة</h1>
            </div>
            <div class="col-sm-6">
...
@section('content')
    <div class="container-fluid pt-3">
        <div class="row justify-content-center">
            <div class="col-md-8"> {{-- عرض أصغر مناسب للحقول القليلة --}}
                ...
                <div class="card card-primary">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0">
                            ...
                            بيانات المنظمة الجديدة
                        </h3>
                    </div>

                    <form action="{{ route('dashboard.organizations.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                   placeholder="أدخل اسم المنظمة" value="{{ old('name') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="code" name="code"
                                                   placeholder="أدخل الكود الخاص بالمنظمة (مثال: GOL)" value="{{ old('code') }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
