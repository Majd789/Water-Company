@extends('layouts.app')
@section('title', 'تعديل حالة محضر التسليم')
...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">تعديل حالة تسليم: <span class="text-primary">{{ $handoverStatus->name }}</span></h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                ...
                <div class="card card-primary">
                    ...
                    <form action="{{ route('dashboard.handover-statuses.update', $handoverStatus->id) }}" method="POST" novalidate>
                        @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                   placeholder="مثال: تم التسليم، لم يتم التسليم، ..." value="{{ old('name', $handoverStatus->name) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
