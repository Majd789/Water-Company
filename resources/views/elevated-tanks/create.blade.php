...
@section('title', 'إضافة خزان مرتفع جديد')
...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">إضافة خزان مرتفع جديد</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">الرئيسية</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('elevated-tanks.index') }}">الخزانات المرتفعة</a></li>
            ...
            <div class="col-lg-11 col-xl-10">
                ...
                @if (auth()->check() && auth()->user()->role_id == 'admin')
                    <div class="card card-success collapsed-card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('elevated_tanks.import') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <p class="text-muted">يمكنك استيراد قائمة بالخزانات المرتفعة دفعة واحدة.</p>
                ...
                <div class="card card-primary">
                    ...
                    <!-- بدء الفورم -->
                    <form action="{{ route('elevated-tanks.store') }}" method="POST" novalidate>
                        @csrf
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="construction_date" id="construction_date" class="form-control"
                                                required>
                                                <option value="جديد"
                                                    {{ old('construction_date') == 'جديد' ? 'selected' : '' }}>جديد
                                                </option>
                                                <option value="قديم"
                                                    {{ old('construction_date') == 'قديم' ? 'selected' : '' }}>قديم
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="tank_shape" id="tank_shape" class="form-control" required>
                                                <option value="" disabled selected>-- اختر شكل الخزان --</option>
                                                <option value="دائري"
                                                    {{ old('tank_shape') == 'دائري' ? 'selected' : '' }}>دائري</option>
                                                <option value="مربع"
                                                    {{ old('tank_shape') == 'مربع' ? 'selected' : '' }}>مربع</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="height" id="height" class="form-control"
                                                value="{{ old('height') }}" placeholder="الارتفاع بالأمتار" required
                                                min="0">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="in_pipe_diameter">قطر الأنبوب الداخل (مم)<span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-arrow-down"></i></span></div>
                                            <input type="number" name="in_pipe_diameter" id="in_pipe_diameter"
                                                class="form-control" value="{{ old('in_pipe_diameter') }}"
                                                placeholder="القطر بالمليمتر" required min="0">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="out_pipe_diameter">قطر الأنبوب الخارج (مم)<span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fas fa-arrow-up"></i></span></div>
                                            <input type="number" name="out_pipe_diameter" id="out_pipe_diameter"
                                                class="form-control" value="{{ old('out_pipe_diameter') }}"
                                                placeholder="القطر بالمليمتر" required min="0">
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{-- 3. الموقع الجغرافي والملاحظات --}}
                            <h5 class="mt-4 mb-3" style="border-bottom: 1px solid #ddd; padding-bottom: 10px;"><i
                                    class="fas fa-map-marked-alt text-warning ml-2"></i>الموقع الجغرافي والملاحظات</h5>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="card-footer text-right">
                            ...
                            <a href="{{ route('elevated-tanks.index') }}" class="btn btn-secondary btn-lg">
