...
return new class extends Migration
{
    ...
    public function up(): void
    {
         Schema::create('project_activities', function (Blueprint $table) {
            ...
            $table->foreignId('unit_id')->constrained('units'); // الربط مع جدول الوحدات الموجود لديك
            $table->foreignId('station_id')->constrained('stations'); // الربط مع جدول المحطات الموجود لديك
