...
@section('content')
    <div class="recent-orders" style="text-align: center ">
        ...
        <div style="text-align: center" class="text-center">
            <a id="btnb" href="{{ route('weekly_reports.index') }}">الرجوع إلى قائمة التقارير</a>
        </div>
                                ...
                                <td>
                                    @if ($report->maintenance_image)
                                        <div style="margin-bottom: 20px">
                                           <img src="{{ asset('storage/' . $report->maintenance_image) }}" alt="صورة أعمال الصيانة" class="image-preview"
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($report->administrative_image)
                                        <div style="margin-bottom: 20px">
                                             <img src="{{ asset('storage/' . $report->administrative_image) }}" alt="صورة الأعمال الإدارية" class="image-preview"
