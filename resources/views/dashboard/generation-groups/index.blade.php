                ...
                <div class="col-12">
                    {{-- قسم الفلترة للأدمن --}}
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('dashboard.generation-groups.index') }}"
                                    id="unitFilterForm">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-0">
                                                <a href="{{ route('dashboard.generation-groups.index') }}"
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools d-flex align-items-center">
                                ...
                                <a href="{{ route('dashboard.generation-groups.export', request()->query()) }}"
                                    class="btn btn-success ml-2">
                                    <i class="fas fa-file-excel"></i> تصدير Excel
                                </a>
                              
                                    <a href="{{ route('dashboard.generation-groups.create') }}" class="btn btn-primary">
                                        ...
                                        @forelse ($generationGroups as $group)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('dashboard.generation-groups.show', $group->id) }}"
                                                            class="btn btn-sm btn-outline-info" title="عرض">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                     
                                                            <a href="{{ route('dashboard.generation-groups.edit', $group->id) }}"
                                                            ...
                                                            <form
                                                                action="{{ route('dashboard.generation-groups.destroy', $group->id) }}"
