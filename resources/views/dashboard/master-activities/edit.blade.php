@extends('layouts.app')
@section('title', 'تعديل بيانات النشاط الرئيسي')
...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">تعديل نشاط رئيسي: <span class="text-primary">{{ $masterActivity->name }}</span></h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                ...
                <div class="card card-primary">
                    ...
                    <form action="{{ route('dashboard.master-activities.update', $masterActivity->id) }}" method="POST" novalidate>
                        @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                   placeholder="مثال: صيانة شبكة المياه" value="{{ old('name', $masterActivity->name) }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="code" name="code"
                                                   placeholder="مثال: SSHM" value="{{ old('code', $masterActivity->code) }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="unit" name="unit"
                                                   placeholder="مثال: piont, ml, lumpsum" value="{{ old('unit', $masterActivity->unit) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
