                ...
                <div class="col-12">
                    {{-- قسم الفلترة للأدمن --}}
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('dashboard.private-wells.index') }}"
                                    id="unitFilterForm">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-0">
                                                <a href="{{ route('dashboard.private-wells.index') }}"
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools d-flex align-items-center">
                                <a href="{{ route('dashboard.private-wells.export', request()->query()) }}"
                                    class="btn btn-success ml-2">
                                    <i class="fas fa-file-excel"></i> تصدير Excel
                                </a>
                                
                                    <a href="{{ route('dashboard.private-wells.create') }}" class="btn btn-primary">
                                        ...
                                        @forelse ($wells as $well)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('dashboard.private-wells.show', $well->id) }}"
                                                            class="btn btn-sm btn-outline-info" title="عرض">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    
                                                            <a href="{{ route('dashboard.private-wells.edit', $well->id) }}"
                                                            ...
                                                            <form
                                                                action="{{ route('dashboard.private-wells.destroy', $well->id) }}"
